...
const RECLAMATION = [
  {phase:1,title:"Assess Before You Do Anything",sub:"First 2–4 weeks",body:"The impulse is to start digging. Resist. Walk the land at different times of day, in different weather. Where does water pool? Where does it dry fastest? Where are existing plants thriving? This observation tells you more than any soil test. Every piece of feral land has its own personality — learn yours before you change it.",steps:["Mark wet zones, dry zones, compacted zones, and frost pockets on a rough map","Identify existing volunteer plants — they're telling you what your soil can and can't do","Get a basic soil test — county extension offices often do this free or very cheap","Note where sun hits longest — those become your priority growing areas","Map existing infrastructure: trees, water sources, slopes, access points","Resist the urge to clear everything immediately — existing plants, even invasives, are holding your soil and preventing erosion while you plan"]},
  {phase:2,title:"Stop the Bleeding",sub:"First season",body:"Feral land has two immediate problems: erosion and compaction. Before you plant anything productive, stabilize the soil. Every piece of neglected land has its own dominant invaders — identify yours and work with that reality rather than against it. This phase is unglamorous but it pays dividends for years.",steps:["Overseed any bare areas immediately with a fast cover crop — winter rye and field peas work almost anywhere. Imperfect is better than bare.","Sheet mulch problem areas: lay cardboard directly over weeds, top with 4–6 inches of wood chips — smothers weeds and feeds soil biology","Establish permanent walking paths before you start growing — foot traffic compaction is one of the biggest soil killers","Install basic water management where you can: simple berms, swales, or earthworks to slow runoff and let water soak in","Start a compost pile immediately — kitchen scraps, garden waste, cardboard. Everything that can rot, goes in.","Identify your most productive existing soil area and concentrate your first-year energy there rather than trying to fix everything at once"]},
  {phase:3,title:"Build the Soil Before You Plant",sub:"Season 1–2",body:"The temptation is to plant everything immediately. The farms that last are the ones that built soil first. Every hour you put into soil this year returns tenfold in yields for the next decade. Your specific soil type — whether it's heavy clay, sandy, volcanic, compacted hardpan, or something else — shapes exactly what you need to do here.",steps:["Sheet mulch future beds now: cardboard → compost → wood chips. Let it sit as long as possible before planting.","Plant daikon or tillage radish in your most compacted areas each fall — they drill through hardpan and leave channels behind when they decompose","Add a minimum of 2–3 inches of compost to every bed before planting anything","Keep any bed not actively producing food under a cover crop — never leave soil bare","Plant comfrey in a permanent spot — its deep roots mine minerals from subsoil and provide free fertility through chop-and-drop for years","Make your own fertility where possible: compost, worm castings, comfrey liquid fertilizer. What you build yourself costs almost nothing.","Inoculate legume seeds with rhizobium bacteria before planting — cheap and dramatically improves nitrogen fixation"]},
  {phase:4,title:"Establish Perennial Structure",sub:"Year 1–3",body:"Annual vegetables are your production crops. Perennials are your infrastructure. Every piece of land benefits from a foundation of deep-rooted, self-sustaining plants that reduce inputs, build habitat, and make the annual beds more productive over time. Choose perennials suited to your specific climate and soil.",steps:["Plant dynamic nutrient accumulators — comfrey, yarrow, and borage work in most climates and provide fertility and beneficial insect habitat for years","Establish perennial herbs suited to your conditions — they earn their space in multiple ways: culinary, medicinal, pest-repelling, pollinator-attracting","Plant fruit trees, canes, or perennial vegetables if budget allows — they start bearing in 2–3 years and compound over time","Create beneficial insect corridors by planting flowering perennials throughout the property, not just in one spot","Source wood chips free from local tree services — permanent deep mulch is one of the highest-return investments you can make","Build thermal mass where your climate calls for it: rocks, water features, or dense plantings near frost-sensitive crops can extend your season significantly"]},
  {phase:5,title:"Manage Pests Systemically",sub:"Ongoing",body:"Feral land carries built-up pest pressure because the predator-prey balance was disrupted during years of neglect. The specific pests you're dealing with depend entirely on your region, climate, and what you're growing — but the approach is the same everywhere: build the ecosystem rather than fight individual battles. You will not spray your way out of this.",steps:["Identify your most damaging pests specifically — use the Pest ID section of this app, photo identification, or your local extension service","Retain some pest populations on sacrificial plants away from your main crops — they're the food source that keeps beneficial predators on your land","Plant diverse flowering habitat throughout the entire property, not just near vegetable beds — beneficial insects need pollen and nectar throughout the season","Row cover on vulnerable crops at transplant is cheaper and more effective than any spray — use it as your first line of defense","Bt and Spinosad for breakthrough pressure — both are biological, break down quickly, and are safe for beneficial insects when used correctly","Be patient: year three pest pressure on a well-managed reclaimed piece of land is dramatically lower than year one. The ecosystem takes time to rebalance."]},
  {phase:6,title:"Scale What Works",sub:"Year 2–5",body:"By year two you have real information: what actually grows well on this specific piece of land, what the market wants, what you enjoy doing. Every piece of land has things it does well and things it resists. The most successful reclamation projects are the ones that learned to work with the land's strengths rather than fight its limitations.",steps:["Expand production in beds and areas that performed well — resist the urge to expand into problem areas before you've solved what makes them difficult","Save seed from your best-performing plants each year — over time you'll develop varieties adapted to your specific conditions and microclimate","Keep detailed records: planting dates, germination rates, yields, pest pressure, what companion combinations worked. This data is irreplaceable.","Invest in infrastructure that pays long-term returns: irrigation, permanent fencing, covered storage, propagation space","Develop value-added products from your surplus — dried herbs, tinctures, cut flower arrangements, seedlings, preserve — to increase revenue per acre","This is a minimum five-year project. The farms that thrive are the ones that didn't try to do everything in year one and burned out before the land had time to respond."]},
];
